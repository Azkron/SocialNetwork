...
/*
Les rectifications suivantes n'ont pas pu être implémentées: 
...
Nous avons rectifié notre premier travail en suivant la série de recommandations reçue le 17/03/2017:
    ...
    - Sign Up => deux users avec la même adressse mail
...
nos pages sont conformes au standard W3C HTML5 (vérifié à l'aide du validateur W3C).
...
/// HERE WE WRITE THE UPDATES WE MADE
